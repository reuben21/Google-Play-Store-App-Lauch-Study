...
#            
#            combo=ttk.Combobox(,values=dates,width=2,state="readonly").place(x=110,y=273)
...
#            datecombo.append(combo)
            combo=ttk.Combobox(val,values=dates,width=2,state="readonly")
            datecombo.append(combo)
            combo.place(x=110,y=273)
            
            combo=ttk.Combobox(val,values=month,width=10,state="readonly")
            datecombo.append(combo)
            combo.place(x=150,y=273)
            
            combo=ttk.Combobox(val,values=years,width=5,state="readonly")
            datecombo.append(combo)
            combo.place(x=240,y=273)
    ...
    print(datecombo)
    btn_save=tk.Button(val,text='Save',state="disabled",width=10,bg="#102131",command=lambda:saveing(txt,btn_save,'C:\\InternshipFinal\\App-data.csv',datecombo))    
...
mcanvas.create_window(400, 200, window=head)
#=====================================================options==================================================
lbl_over = Button(root,text = "Add Data",width=25,height='2',font=("Lucida",13,'italic'),fg='#ffffff',bg='black',command=add_app_data)
